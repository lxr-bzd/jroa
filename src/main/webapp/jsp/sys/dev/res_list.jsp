...
<script type="text/javascript" src="${path}/js/jquery.base64.js"></script>
   <script src="<%=request.getContextPath()%>/jslib/layer/layer.js"></script>
<title>查询列表</title>
<script>
	//添加
	function toAdd(){
...
<body>
    ...
    <div class="rightinfo">
	    ...
	    <div id="toolbar" class="btn-group">
	     <button class="btn btn-success btn-round btn-sm" onclick="test()">
						<i class="glyphicon glyphicon-folder-open"></i>  &nbsp;test
				</button>
