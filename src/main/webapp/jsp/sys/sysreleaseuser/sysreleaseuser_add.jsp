...
<script type="text/javascript">
	...
	function toSubmit(){
		...
		var imgFilePath=$.trim($("#imgFilePath").val());
		if(!userName){
			$app.alert('发布方名称不能为空');
		...
		if(email){
			flag=regEmail(email);
			if(!flag){
				$app.alert('电子邮箱不合法，请重新输入一个');
			
				return ;
			}else if(checkIsExist(email,"2")){
				$app.alert('电子邮箱已经注册，请重新输入一个');
		...
		<div class="place">
		    ...
		    <ul class="placeul">
		    	...
		    	<li><a href="javascript:">会员管理</a></li>
		   		<li><a href="javascript:">添加发布方</a></li>
		    </ul>
	    </div>
		<div class="formbody">
   			...
   			<form id="add_form" method="post">
				<ul class="forminfo">
					...
					<li><label>图像地址：<font color="red">*</font></label><input name="imgFilePath" id="imgFilePath" type="text" class="form-control input-primary" style="width:350px" readonly="readonly"/> <input name="" type="button" class="btn btn-primary" value="编辑图像" onclick="toMeituUpload()"/> </li>
