		...
		<div class="place">
		    ...
		    <ul class="placeul">
		    	...
		    	<li><a href="javascript:">会员管理</a></li>
		   		<li><a href="javascript:">编辑发布方</a></li>
		    </ul>
	    </div>
		<div class="formbody">
   			...
   			<form id="submit_form" method="post">
				...
				<ul class="forminfo">
					...
					<li><label>图像地址：<font color="red">*</font></label><input name="imgFilePath" value="${vo.imgFilePath }" id="imgFilePath" type="text" class="form-control input-primary" style="width:350px" readonly="readonly"/> <input name="" type="button" class="btn btn-primary" value="编辑图像" onclick="toMeituUpload()"/> </li>
