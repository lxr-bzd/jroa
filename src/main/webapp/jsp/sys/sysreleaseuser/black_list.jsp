...
<script>
	...
	function toSet(type){
		...
		if(ids){
			...
			if(type=='2'){
				url='${path}/sysReleaseUserController/setCommon.do?ids='+ids;
			}
...
<body>
    ...
    <ul class="placeul">
		    	...
		    	<li><a href="javascript:">会员管理</a></li>
		   		<li><a href="javascript:">无权限发布方列表</a></li>
    </ul>
    </div>
    ...
    <div class="rightinfo">
	    ...
	    <div id="toolbar" class="btn-group">
	    	<shiro:hasPermission name="SysReleaseUser1:setWhite">
	    		<button class="btn btn-warning btn-round" onclick="toSet();">
					<i class="glyphicon glyphicon-pencil"></i>设置为高级发布方
				</button>
	    	</shiro:hasPermission>
			<shiro:hasPermission name="SysReleaseUser1:setCommon">
