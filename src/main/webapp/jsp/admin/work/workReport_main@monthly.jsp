...
var toInfoUrl = '${path}/admin/work/workReport/toinfo.do';
	...
	//添加
	function toAdd(){
		$app.dialog(toAddUrl+"?sysModule=monthly",function(){
			refTable();
    ...
    function editById(id){
		$app.dialog(toEditUrl+'?id='+id+"&sysAction=edit&sysModule=monthly",function(){
			refTable();
		},{width:"900px",height:"600px"});
	}
...
function toExamine(id){
	$app.dialog("${path}/admin/work/workReport/toexamine.do?sysModule=monthly&id="+id,function(){
		refTable();
	},{width:"900px",height:"600px"});
    ...
    <div class="rightinfo explain_col">
	   ...
	   <button class="btn btn-info btn-round  btn-sm" onclick="toAdd();" >
    	...
    	<table class="table_list" id="mainTable" data-toggle="table"
			data-url="${path}/admin/work/workReport/view.do?type=3" data-pagination="ture" 
