...
<title>查询列表</title>
<script>
var toAddUrl = '${path}/customer/customer/cusType/toedit.do';
var deleteUrl = '${path}/customer/customer/cusType/delete.do';
var toEditUrl = '${path}/customer/customer/cusType/toedit.do';
var toInfoUrl = '${path}/customer/customer/cusType/view.do';
    ...
    <div class="rightinfo explain_col">
	   ...
	   <button class="btn btn-info btn-round  btn-sm" onclick="toAdd();" >
    	...
    	<table class="table_list" id="mainTable" data-toggle="table"
			data-url="${path}/customer/customer/cusType/view.do" data-pagination="ture" 
