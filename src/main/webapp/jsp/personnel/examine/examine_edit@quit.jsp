...
<c:if test="${param.sysAction=='edit'}">
   			...
   			<form id="submit_form"  method="post" data-action="${path}/personnel/examine/examine/save.do">
   				...
   				<ul class="forminfo">
					...
					<li><label>离职时间：</label><input readonly="readonly" data-lxr="{type:'time',format:'yyyy-MM-dd'}" data-format="{type:'time',val:'${vo.starttime }',format:'yyyy-MM-dd'}" value="" placeholder="时间" style="display: inline" type="text" class="starttime lxr-format form-control input-primary  w260" >
					</li>
