...
<c:if test="${empty param.action}">
   			...
   			<form id="submit_form" data-isadd="true" method="post" data-action="${path}/personnel/apply/apply/save.do">
   				...
   				<ul class="forminfo">
					...
					<li><label>加班原由：</label><textarea name="info" class="form-control input-primary w260"></textarea>
					</li>
	    		</ul>
    			<div class="btnWrap">
...
<!--<div class="formtitle"><span>基本信息</span></div>-->
   			<form id="submit_form"  method="post" data-action="${path}/personnel/apply/apply/update.do">
   				...
   				<ul class="forminfo">
					...
					<li><label>加班原由：</label><textarea name="info" class="form-control input-primary w260">${vo.info }</textarea>
					</li>
