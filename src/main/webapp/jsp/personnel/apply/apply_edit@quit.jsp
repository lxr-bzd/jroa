...
<c:if test="${empty param.action}">
   			...
   			<form id="submit_form" data-isadd="true" method="post" data-action="${path}/personnel/apply/apply/save.do">
   				...
   				<li><label>离职时间：</label><input data-lxr="{type:'time',format:'yyyy-MM-dd hh:mm:ss'}" value="" placeholder="离职时间" style="display: inline" type="text" class="lxr-format wdateExt Wdate input-primary w260" onfocus="WdatePicker({isShowClear:false,dateFmt:'yyyy-MM-dd HH:mm:ss'})" >
    				<input name="starttime" type="hidden">
    				</li>
					
					
					<li><label>离职原由：</label><textarea name="info" class="form-control input-primary w260"></textarea>
					</li>
	    		</ul>
    			<div class="btnWrap">
...
<c:if test="${param.action=='edit'}">
   			...
   			<form id="submit_form"  method="post" data-action="${path}/personnel/apply/apply/update.do">
   				...
   				<ul class="forminfo">
					...
					<li><label>离职时间：</label><input data-lxr="{type:'time',format:'yyyy-MM-dd hh:mm:ss'}"
					 data-format="{type:'time',val:'${vo.starttime }',format:'yyyy-MM-dd hh:mm:ss'}"  placeholder="离职时间" style="display: inline" type="text" class="lxr-format wdateExt Wdate input-primary w260" onfocus="WdatePicker({isShowClear:false,dateFmt:'yyyy-MM-dd HH:mm:ss'})" >
    				<input name="starttime" type="hidden">
    				</li>
