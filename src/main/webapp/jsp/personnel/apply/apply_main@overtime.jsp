...
<title>查询列表</title>
<script>
var toAddUrl = '${path}/personnel/apply/apply/toedit.do?sysModule=overtime';
...
var updateUrl = '${path}/personnel/apply/apply/update.do';
    ...
    function editById(id){
    	$app.dialog(toEditUrl+'?sysModule=overtime&id='+id+"&action=edit",function(){
			refleshData('mainTable');
		},{width:"520px",height:"380px"});
	}
...
<body class="mlr15">
	   ...
	   <button class="btn btn-info btn-round  btn-sm" onclick="toAdd();" >
    	...
    	<table class="table_list" id="mainTable" data-toggle="table"
			data-url="${path}/personnel/apply/apply/view.do?applytype=2" data-pagination="ture" 
			...
			<thead>
				<tr>
					...
					<th data-field="length" data-formatter="lengthFormatter">加班时长</th>
