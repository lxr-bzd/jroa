...
<title>查询列表</title>
<script>
var toAddUrl = '${path}/project/setting/progress/toedit.do';
var deleteUrl = '${path}/project/setting/progress/delete.do';
var toEditUrl = '${path}/project/setting/progress/toedit.do';
var toInfoUrl = '${path}/project/setting/progress/view.do';
    ...
    <div class="rightinfo explain_col">
	   ...
	   <button class="btn btn-info btn-round  btn-sm" onclick="toAdd();" >
    	...
    	<table class="table_list" id="mainTable" data-toggle="table"
			data-url="${path}/project/setting/progress/view.do" data-pagination="ture" 
